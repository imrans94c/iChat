...
class InviteUsersTableViewController: UITableViewController, userTableViewCellDelegate {
    ...
    func updateGroup(group:NSDictionary){
        ...
        createRecentForNewMembers(groupId: group[kGROUPID] as! String, groupName: group[kNAME] as! String, membersToPush: tempMembersToPush, avatar: group[kGROUPID] as! String)
    ...
    fileprivate func splitDataIntoSection(){
        ...
        for i in 0..<self.allUsers.count{
            ...
            if firstCarString != sectionTitle{
                ...
                if !self.sectionTitleList.contains(sectionTitle){
